...
export const setSelectDataSource = makeActionCreator(SET_SELECT_OPTIMIZED_PAGE_SELECT_DATA_SOURCE, 'param');
export const setSelect2DataSource = makeActionCreator(SET_SELECT_OPTIMIZED_PAGE_SELECT_2_DATA_SOURCE, 'param');
export const setSelect3DataSource = makeActionCreator(SET_SELECT_OPTIMIZED_PAGE_SELECT_3_DATA_SOURCE, 'param');

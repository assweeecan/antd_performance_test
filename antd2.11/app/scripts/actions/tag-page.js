...
export const setTagDataSource = makeActionCreator(SET_TAG_PAGE_SELECT_DATA_SOURCE, 'param');
export const setTag2DataSource = makeActionCreator(SET_TAG_PAGE_SELECT_2_DATA_SOURCE, 'param');
...
export function fetchGetSelectDataSource() {
  return async (dispatch) => {
    ...
    dispatch(setTagDataSource(dataSource));
  };
}
...
export function fetchGetSelect2DataSource() {
  return async (dispatch) => {
    ...
    dispatch(setTag2DataSource(dataSource));
  };
}
